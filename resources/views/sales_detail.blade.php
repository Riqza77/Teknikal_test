            ...
            <div class="card col-12">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            <h4>
                                <i class="fas fa-globe"></i> No Penjualan : {{ $sales->number }}
                                <small class="float-right">Tanggal:
                                    {{ \Carbon\Carbon::parse($sales->date)->translatedFormat('l, d F Y') }}</small>
                            </h4>
                        </div>
                        <!-- /.col -->
                    </div>
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                                ...
                                <div class="modal fade" id="EditModal{{ $pcs->id }}" tabindex="-1">
                                    <div class="modal-dialog modal-md">
                                        <div class="modal-content">
                                            ...
                                            <form action="/sales_detail_edit" method="post">
                                                @csrf
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th>Rp.
                                    {{ number_format(\App\Models\Sales_detail::where('sales_id', $sales->id)->pluck('price')->sum(),0,',','.') }},-
                                </th>
